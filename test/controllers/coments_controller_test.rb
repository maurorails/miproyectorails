...
class ComentsControllerTest < ActionController::TestCase
  ...
  test "should create coment" do
    assert_difference('Coment.count') do
      post :create, coment: { description: @coment.description, posts_id: @coment.posts_id, usuario: @coment.usuario }
    end
  ...
  test "should update coment" do
    patch :update, id: @coment, coment: { description: @coment.description, posts_id: @coment.posts_id, usuario: @coment.usuario }
    assert_redirected_to coment_path(assigns(:coment))
  end
